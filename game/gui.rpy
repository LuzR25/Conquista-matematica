...
define gui.accent_color = '#0072be'

define gui.title_color = '#a37d2b'
...
define gui.hover_color = '#1785ce' #0099ff
...
define gui.name_text_font = "fonts/PixelOperator.ttf"
...
define gui.main_menu_background = Movie(play = "images/Título.webm")   #"images/Fondo_Basta_Matematico.png" #"gui/main_menu.png"
...
## Puede ser el número de píxels desde la esquina superior izquierda, o 0.5 para
## centrar.
...
define config.thumbnail_width = 384 #*Tomar en cuenta para los tamaños de los avatares
define config.thumbnail_height = 216 #*Justo debajo se indica la cantidad de slots que van apareciendo en pantalla
...
define gui.navigation_xpos = 60 #*Aquí defino la posición de las opciones del menú
#define gui.navigationMainMenu_xpos = 480
