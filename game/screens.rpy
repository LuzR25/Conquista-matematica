...
screen main_menu():
    ...
    #Quitar ese frame mejor. Subir el título hasta arriba y ponerlo al centro
    #Y mover las opciones para que estén en el centro también. Cambiar su color
    #y ver que pongan en negritas algo así. Si se puede, añadir una animación 
    #al título
...
style main_menu_frame:
    ...
    background "gui/overlay/main_menu.png"  #"images/Fondo_Basta_Matematico.png"
...
style main_menu_title:
    ...
    #properties gui.text_properties(xalign="center", textalign="center", size=100, color="#FF0000")
        ...
        fixed:
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    $ slot = i+1
                    #$ mostrarNombre = str(slot) + " " + persistent.nombreUsuario
                    #$ slot = persistent.nombres[i]
